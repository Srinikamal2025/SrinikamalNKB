...
function closeModal(){
  ['roomModal','paymentModal','customerModal','allCustomersModal','confirmModal']
    .forEach(id => { const el = document.getElementById(id); if(el) el.classList.add('hidden');});
}

/* Bind close buttons */
['closeRoomModal','cancelRoomBtn','closePaymentModal','closeCustomerModal',
 'closeAllCustomersModal','paymentCancelBtn','customerCancelBtn']
.forEach(id => {
